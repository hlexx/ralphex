...
// buildFirstReviewPrompt creates the prompt for the first review pass.
// when codex is the primary executor, a codex-specific prompt can override the default review prompt.
...
// buildSecondReviewPrompt creates the prompt for iterative follow-up review passes.
// when codex is the primary executor, a codex-specific prompt can override the default review prompt.
